...
const char* UpgradeV1LayerType(const V1LayerParameter_LayerType type) {
  ...
  case V1LayerParameter_LayerType_THRESHOLD:
    return "Threshold";
  case V1LayerParameter_LayerType_SEMIPAIR_LOSS:
    return "SemiPairLoss";
  case V1LayerParameter_LayerType_SEMICONTRAST_LOSS:
    return "SemiContrastLoss";
  case V1LayerParameter_LayerType_SEMIRANK_LOSS:
    return "SemiRankLoss";
  default:
